		  ...
		  <tbody>
		    ...
		    <tr>
 		    ...
 		    <tr>
		      ...
		      <td class=""><?php echo $row['outcome_date']; ?></td>
		      <td class="font-weight-bold">Remark</td>
		      <td class=""><?php echo $row['vehicle_remark']; ?></td>
		    </tr>
  		    <tr>
		      <td class="font-weight-bold">Parking Free</td>
		      <td class=""><?php echo $row['parking_charge']; ?></td>
		    </tr>
		  </tbody>
		</table>
	</div>
